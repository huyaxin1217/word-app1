...
function BookCard({ title, desc, isCurrent }: any) {
  return (
    <div className={`p-5 rounded-2xl border ${isCurrent ? 'bg-teal-500 text-white border-teal-600 shadow-lg shadow-teal-500/20' : 'bg-white/40 backdrop-blur-xl text-slate-800 border-white/60 shadow-sm'} flex items-center justify-between cursor-pointer hover:scale-[1.02] active:scale-95 transition-all duration-300`}>
